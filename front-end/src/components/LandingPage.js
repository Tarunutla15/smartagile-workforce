  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 relative overflow-hidden">
      ...
      <nav className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-wrap items-center justify-between gap-4">
        ...
        >
          <span className="w-11 h-11 rounded-xl bg-gradient-to-br from-teal-500 to-emerald-700 shadow-md shadow-teal-900/15 flex items-center justify-center overflow-hidden ring-2 ring-white">
            <img
              src={logo}
              alt=""
          ...
          <span className="font-display text-xl font-semibold tracking-tight text-slate-900 group-hover:text-teal-800 transition-colors">
            SmartAgile
          </span>
        </Link>
        <div className="flex items-center gap-1 sm:gap-2 text-sm font-medium">
          <Link
            to="/"
            className="px-3 py-2 rounded-lg text-slate-600 hover:text-slate-900 hover:bg-white/70 transition-colors"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            to="/login"
            className="ml-1 px-4 py-2 rounded-lg bg-slate-900 text-white hover:bg-teal-700 shadow-sm transition-colors"
          >
            Login
          </Link>
        </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pb-20 pt-6 sm:pt-12">
        <div className="max-w-3xl mx-auto text-center">
          <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-teal-700 bg-teal-50 border border-teal-100 rounded-full px-4 py-1.5 mb-6">
            Workplace intelligence
          </p>
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tight">
            Agile workflows,{" "}
        ...
        <div className="mt-16 sm:mt-24 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl w-full text-left">
          {[
            ...
            <div
              key={item.title}
              className="rounded-2xl bg-white/80 border border-slate-200/80 p-5 shadow-sm shadow-slate-900/5 backdrop-blur-sm hover:border-teal-200/80 transition-colors"
            >
